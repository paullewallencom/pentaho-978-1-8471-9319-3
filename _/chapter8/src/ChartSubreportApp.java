...
public class ChartSubreportApp extends JFrame { 

	// constructor which displays the simple 
	// application shell
	
	public ChartSubreportApp() { 
		super("Chart Subreport App"); 
		...
		add(new JLabel("Chart Subreport Application")); 
	...
	public void onPreview() { 
		...
		try {
			...
			Resource res = manager.createDirectly(
				new URL("file:data/subreport_chart.prpt"), MasterReport.class);
	...
	public static void main(String args[]) {
		...
		ChartSubreportApp app = new ChartSubreportApp(); 
		app.pack(); 
		app.setVisible(true); 
	} 
}
