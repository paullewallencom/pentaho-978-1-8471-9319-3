...
public class SideBySideSubreportApp extends JFrame { 

	// constructor which displays the simple 
	// application shell
	
	public SideBySideSubreportApp() { 
		super("Side-By-Side Subreport App"); 
		...
		add(new JLabel("Side-By-Side Subreport Application")); 
	...
	public void onPreview() { 
		...
		try {
			...
			Resource res = manager.createDirectly(
				new URL("file:data/subreport_sidebyside.prpt"), MasterReport.class);
	...
	public static void main(String args[]) {
		...
		SideBySideSubreportApp app = new SideBySideSubreportApp(); 
		app.pack(); 
		app.setVisible(true); 
	} 
}
