...
public class MultipageSubreportApp extends JFrame { 

	// constructor which displays the simple 
	// application shell
	
	public MultipageSubreportApp() { 
		super("Multipage Subreport App"); 
		...
		add(new JLabel("Multipage Subreport Application")); 
	...
	public void onPreview() { 
		...
		try {
			...
			Resource res = manager.createDirectly(
				new URL("file:data/subreport_multipage.prpt"), MasterReport.class);
	...
	public static void main(String args[]) {
		...
		MultipageSubreportApp app = new MultipageSubreportApp(); 
		app.pack(); 
		app.setVisible(true); 
	} 
}
