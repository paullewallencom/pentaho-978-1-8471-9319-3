...
public class XPathDataFactoryApp extends JFrame { 

	// constructor which displays the simple 
	// application shell
	
	public XPathDataFactoryApp() { 
		super("XPathDataFactoryApp"); 
		...
		add(new JLabel("Chapter 5 XPathDataFactoryApp Application")); 
	...
	public void onPreview() { 
		...
		try {
			...
			Resource res = manager.createDirectly(
				new URL("file:data/xpath_report.prpt"), MasterReport.class);
			MasterReport report = (MasterReport) res.getResource();
			
			// load XPathDataFactory
			XPathDataFactory factory = new XPathDataFactory();
			factory.setXqueryDataFile("file:data/xpathexample.xml");
			factory.setQuery("default","/ExampleResultSet/Row");
	...
	public static void main(String args[]) {
		...
		XPathDataFactoryApp app = new XPathDataFactoryApp(); 
		app.pack(); 
		app.setVisible(true); 
	} 
}
